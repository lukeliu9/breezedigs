Sitemap::Generator.instance.load :host => "www.breezedigs.com" do


  path :root, :priority => 1
  literal "/sitemap" #helpful for vanity urls layering search results
  resources :buildings, :params => { :format => "html" }
  # Sample path:
  #   path :faq
